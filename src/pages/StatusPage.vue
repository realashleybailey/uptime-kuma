    ...
    <div v-if="loadedTheme" class="container mt-3">
        ...
        <div :class="{ edit: enableEditMode }" class="main">
            ...
            <h1 class="mb-4 title-flex">
                ...
                <!-- Uploader -->
                <!--    url="/kuma/api/status-page/upload-logo" -->
                <ImageCropUpload
            ...
            <div v-if="hasToken" class="mb-4">
                <div v-if="!enableEditMode">
                    ...
                    <a href="/kuma/manage-status-page" class="btn btn-info">
                ...
                <div class="mt-3">
                    <div v-if="allMonitorList.length > 0 && loadedData">
                        ...
                        <select v-model="selectedMonitor" class="form-control">
                            <option
                                v-for="monitor in allMonitorList"
                                :key="monitor.id"
                                :value="monitor"
                            >
                                {{ monitor.name }}
            ...
            <footer class="mt-5 mb-4">
                ...
                <p v-if="config.showPoweredBy">
                    ...
                    <a
                        ...
                        href="https://github.com/realashleybailey/uptime-kuma"
                        >{{ $t("Uptime Kuma") }}</a
                    >
                </p>
            </footer>
        ...
        this.getData()
            ...
            .catch(function (error) {
                if (error.response.status === 404) {
                    location.href = "/kuma/page-not-found";
                }
                console.log(error);
            });
    ...
    methods: {
        ...
        getData: function () {
            if (window.preloadData) {
                ...
                return axios.get("/kuma/api/status-page/" + this.slug);
            }
        },
        ...
        updateHeartbeatList() {
            ...
            if (!this.editMode) {
                axios
                    .get("/kuma/api/status-page/heartbeat/" + this.slug)
                    .then((res) => {
        ...
        deleteStatusPage() {
            this.$root
                ...
                .emit("deleteStatusPage", this.slug, (res) => {
                    if (res.ok) {
                        this.enableEditMode = false;
                        location.href = "/kuma/manage-status-page";
                    } else {
                        toast.error(res.msg);
                    }
                });
