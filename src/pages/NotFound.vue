<template>
    <div>
        ...
        <header v-if="! $root.isMobile" class="d-flex flex-wrap justify-content-center py-3 mb-3 border-bottom">
            <router-link to="/kuma/" class="d-flex align-items-center mb-3 mb-md-0 me-md-auto text-dark text-decoration-none">
        ...
        <div class="content">
            ...
            <div class="guide">
                ...
                <ul>
                    ...
                    <li><a href="/kuma/" class="go-back">Go back to home page.</a></li>
                </ul>
            </div>
        </div>
    </div>
