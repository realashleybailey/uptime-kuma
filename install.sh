...
# curl -o kuma_install.sh https://raw.githubusercontent.com/realashleybailey/uptime-kuma/master/install.sh && sudo bash kuma_install.sh
"echo" "-e" "====================="
...
"echo" "-e" "For advanced usage, please go to https://github.com/realashleybailey/uptime-kuma/wiki/Installation"
"echo" "-e" "---------------------------------------"
"echo" "-e" ""
...
if [ "$type" == "local" ]; then
  ...
  docker run -d --restart=always -p $port:3001 -v $volume:/app/data --name uptime-kuma realashleybailey/uptime-kuma:1
fi
