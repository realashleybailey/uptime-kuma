...
class Database {
    ...
    static async patch() {
        ...
        if (version === this.latestVersion) {
            ...
            try {
                ...
                log.error("db", "Please submit a bug report if you still encounter the problem after restart: https://github.com/realashleybailey/uptime-kuma/issues");
    ...
    static async patch2() {
        ...
        try {
            ...
            log.error("db", ex);
            log.error("db", "Start Uptime-Kuma failed due to issue patching the database");
            log.error("db", "Please submit the bug report if you still encounter the problem after restart: https://github.com/realashleybailey/uptime-kuma/issues");
